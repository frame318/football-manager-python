...
lazlo = ['Lazio','FELIPE CAICEDO','CIRO IMMOBILE','NAANI','DAVIDE DI GENNARO','FELIPE ANDERSON','NICOLO ARMINI','DUSAN BASTA','BASTOS','JORDAN LUKAKU','MAURICIO','THOMAS STRAKOSHA']
